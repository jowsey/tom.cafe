...
<div class="flex h-dvh w-dvw">
	<div
		class="flex h-full w-72 shrink-0 flex-col divide-y divide-solid divide-zinc-700 border-r border-zinc-700"
	>
		<a
			href={resolve('/')}
			class="p-6 text-5xl font-bold text-cyan-50 transition-all hover:bg-zinc-50/2 hover:font-extrabold hover:text-fuchsia-100 active:bg-zinc-50/4"
		>
			THOMAS<br />JOWSEY
		</a>
	...
	<div class="min-h-full grow overflow-auto">
		{@render children()}
	</div>
</div>
